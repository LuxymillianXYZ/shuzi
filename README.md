# Shuzi 
#### Shuzi is a super minimal lightweight image viewer designed to quickly look at images through the terminal or with a minimal GUI
##### Shuzi is written in C with SDL2.
